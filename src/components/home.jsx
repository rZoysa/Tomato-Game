    ...
    <div className="flex justify-center items-center h-screen">
      <div className="bg-[#3191B0] bg-opacity-80 rounded-3xl w-11/12 h-5/6">
        <div className="flex justify-between items-center ">
          <div className="ml-10 m-24">
            <h1 className="text-6xl font-bold">Tomato Quiz Game</h1>
          </div>
          <Menu as="div" className="w-fit mr-28">
            ...
            >
              <Menu.Items className="absolute right-0 mt-2 mr-20 w-40 origin-top-right divide-y divide-gray-100 rounded-md p-1 bg-white shadow-lg ring-1 ring-black/5 focus:outline-none">
                {!userId ? (
                  <>
                    <Menu.Item>
                      {({ active }) => (
