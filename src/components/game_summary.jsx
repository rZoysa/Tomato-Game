...
function Game_summary({ restartGame, onClose, score }) {
  ...
  return (
    <div className="bg-black fixed w-screen h-screen bg-opacity-45">
      <motion.div
        className="box"
      ...
      >
        <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-8 rounded-lg shadow-lg z-50 w-2/5 h-3/5">
